        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-2">
          {THEMES.map((t) => (
            ...
            >
              ...
              <div className="grid grid-cols-5 grid-rows-3 w-full rounded-lg overflow-hidden" data-theme={t}>
                <div className="bg-base-200 col-start-1 row-span-2 row-start-1"></div>
                <div className="bg-base-300 col-start-1 row-start-3"></div>
                <div className="bg-base-100 col-span-4 col-start-2 row-span-3 row-start-1 flex flex-col gap-1 p-2 rounded">
                  <div className="font-bold text-xs truncate text-left">{t}</div>
              ...
              <div className="bg-base-100 rounded-xl shadow-sm overflow-hidden">
                ...
                <div className="px-4 py-3 border-b border-base-300 bg-base-100">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-medium text-sm">Ayush Behera</h3>
                ...
                {/* Chat Messages */}
                <div data-theme={theme} className="p-4 space-y-4 min-h-[200px] max-h-[200px] overflow-y-auto bg-base-100">
